...
500.times do |i|
	...
	array.uniq!
	p 	matcheur = User.create(hash: {interest: random_interest, biography: Faker::Quotes::Shakespeare.romeo_and_juliet_quote ,first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, password: "coucou123/", sex: ['man', 'woman'].sample, age: rand(18..35), email: Faker::Internet.unique.email, email_token: SecureRandom.hex, latitude: rand(48.0..48.9).to_s, longitude: rand(2.0..3.9).to_s})[0]	
